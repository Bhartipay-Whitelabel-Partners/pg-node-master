...
var payment_url = {
    'prod': 'https://merchant.pg.com/crm/jsp/paymentrequest',
...
module.exports = {
    headers: {
        'authorization': 'YOUR-AUTHORIZATION-HEADER' // will be provided by pg
    },

    credentails: {
        'pay_id': 'YOUR-MERCHANT-KEY', // will be provided by pg
        'salt': 'YOUR-SALT-KEY', // will be provided by pg
    },
    ...
    getPaymentUrl: function() {
        if (this.mode == 'prod') {
            return 'https://merchant.pg.com/crm/jsp/paymentrequest';
        } else {
            return 'https://uat.pg.com/crm/jsp/paymentrequest';
        }
    },
