...
const port = 3000;
const pg_payid = 'XXXXXXXXXXXXXXXX';
const pg_salt = 'XXXXXXXXXXXXXXXX';
const server = http.createServer((req, res) => {
    pg.isProdMode(false);
    pg.setCredentails(pg_payid, pg_salt);
    switch (req.url) {
        case "/":
        res.statusCode = 200;
        ...
        res.write('<title>Pg Demo Merchant Checkout Page</title>');
        ...
        res.write('<td class="form-control">');
        res.write('<input type="text" name="MERCHANTNAME" class="signuptextfield" value="Pg Demo" autocomplete="off"/>');
        res.write('</td>');
        res.write('</tr>');
        res.write('<tr>');
        ...
        res.write('<td class="form-control">');
        res.write('<input type="text" name="CUST_NAME" class="signuptextfield" value="Pg DEMO" autocomplete="off"/>');
        res.write('</td>');
        res.write('</tr>                   ');
        res.write('<tr>');
        ...
        res.write('<td class="form-control">');
        res.write('<input type="text" name="CUST_EMAIL" class="signuptextfield" value="test.user@pg.com" autocomplete="off"/>');
        res.write('</td>');
        res.write('</tr>');
        res.write('<tr>');
        ...
        if(req.method === 'POST') {
            collectRequestData(req, result => {
                if (result) {
                    ...
                    var transaction = pg.createTransaction(data);
                    var gateway_url = pg.getPaymentUrl();
